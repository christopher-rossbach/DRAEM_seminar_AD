...
Besides a reduced memory footprint, the implementation of micro-batches fixed a bug in the original code, where the last incomplete batch of each epoch was weighted incorrectly during training (see Figure~\ref{fig:smooth-loss-curve} in the appendinx).
