...
% Setup for Titlepage
% ----------------------------------------------------------------------------------------
\title[DRÆM Presentation]{DRÆM - ICCV 2021}
\subtitle{A Discriminatively Trained Reconstruction Embedding for Surface Anomaly Detection -- Vitjan Zavrtanik, Matej Kristan, Danijel Skočaj}
